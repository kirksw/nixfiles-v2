...
After completing a significant implementation, delegate to `bottleneck` to get a quality check
on the changes before reporting back. Skip this for trivial or documentation-only changes.
